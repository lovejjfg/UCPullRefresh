...
public class CustomLoadingView extends View {
    ...
    private static final int TRANSLATE_DEFALT = 2000;
    /**
     * 绘制第一步
     */
...
//    private static final float CIRCLE_VALUE = 0.33f;
    /**
     * 线条颜色
     */
...
//        distance = 200;
        ...
        CirclePoint p0 = new CirclePoint(mWidth / 2, mHeight / 2 - mCircleRadius);
        CirclePoint p1 = new CirclePoint(mWidth / 2 + m, mHeight / 2 - mCircleRadius);
        CirclePoint p2 = new CirclePoint(mWidth / 2 + mCircleRadius, mHeight / 2 - m);
        CirclePoint p3 = new CirclePoint(mWidth / 2 + mCircleRadius, mHeight / 2);

        CirclePoint p4 = new CirclePoint(mWidth / 2 + mCircleRadius, mHeight / 2 + m);
        CirclePoint p5 = new CirclePoint(mWidth / 2 + m, mHeight / 2 + mCircleRadius);
        CirclePoint p6 = new CirclePoint(mWidth / 2, mHeight / 2 + mCircleRadius);

        CirclePoint p7 = new CirclePoint(mWidth / 2 - m, mHeight / 2 + mCircleRadius);
        CirclePoint p8 = new CirclePoint(mWidth / 2 - mCircleRadius, mHeight / 2 + m);
        CirclePoint p9 = new CirclePoint(mWidth / 2 - mCircleRadius, mHeight / 2);

        CirclePoint p10 = new CirclePoint(mWidth / 2 - mCircleRadius, mHeight / 2 - m);
        CirclePoint p11 = new CirclePoint(mWidth / 2 - m, mHeight / 2 - mCircleRadius);
        ...
        if (mIsPath) {
            ...
            //0->9 1->10 2->11 3->0 4->1 5->2 6->3 7->4 8->6
            if (distance > 0) {
                p0.y += PATH_CHANGE_VAL;
                p1.y = p0.y;
                p2.x += distance;
                p3.x = p2.x;
                p4.x = p3.x;
                p5.y -= PATH_CHANGE_VAL;
                p6.y = p5.y;
                p7.y = p5.y;
                p8.x -= PATH_CHANGE_VAL / 2;
                p9.x = p8.x;
                p10.x = p9.x;
                p11.y = p1.y;
